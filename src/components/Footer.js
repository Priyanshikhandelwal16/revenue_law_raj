          ...
          <div className="footer-column footer-column-wide" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            <div className="footer-logo" style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', lineHeight: '1.1' }}>
                ...
                <span style={{ fontFamily: 'var(--font-sans)', fontSize: '0.65rem', fontWeight: 600, color: 'var(--text-muted)', letterSpacing: '1px', marginTop: '0.2rem' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', marginTop: '0.5rem' }}>
              <a href="https://www.facebook.com/profile.php?id=61591658014580" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-muted)', transition: 'color 0.2s', padding: '0.5rem', backgroundColor: 'rgba(10, 25, 47, 0.05)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }} onMouseEnter={e => e.currentTarget.style.color = 'var(--accent-gold)'} onMouseLeave={e => e.currentTarget.style.color = 'var(--text-muted)'}>
                <Facebook size={16} />
              </a>
              <a href="https://x.com/revenuelawraj" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-muted)', transition: 'color 0.2s', padding: '0.5rem', backgroundColor: 'rgba(10, 25, 47, 0.05)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }} onMouseEnter={e => e.currentTarget.style.color = 'var(--accent-gold)'} onMouseLeave={e => e.currentTarget.style.color = 'var(--text-muted)'}>
                <Twitter size={16} />
              </a>
              <a href="https://www.youtube.com/@revenuelawraj" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-muted)', transition: 'color 0.2s', padding: '0.5rem', backgroundColor: 'rgba(10, 25, 47, 0.05)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }} onMouseEnter={e => e.currentTarget.style.color = 'var(--accent-gold)'} onMouseLeave={e => e.currentTarget.style.color = 'var(--text-muted)'}>
                <Youtube size={16} />
              </a>
              <a href="https://www.instagram.com/revenuelawraj/" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-muted)', transition: 'color 0.2s', padding: '0.5rem', backgroundColor: 'rgba(10, 25, 47, 0.05)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }} onMouseEnter={e => e.currentTarget.style.color = 'var(--accent-gold)'} onMouseLeave={e => e.currentTarget.style.color = 'var(--text-muted)'}>
                <Instagram size={16} />
              </a>
            </div>
          </div>
