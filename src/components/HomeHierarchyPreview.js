...
const courtsDetail = [
  {
    ...
    role: "Appellate & Revisional Authority (Highest Court in the State)",
    shortDesc: "Apex judicial body and highest revenue court in the state of Rajasthan."
  },
  {
    id: 5,
  ...
  },
  {
    ...
    name: "Revenue Appellate Authority (RAA)",
    role: "Appellate Court above District Collector",
    shortDesc: "Appellate court positioned above District Collector to hear revenue appeals in land disputes."
  },
  {
    id: 3,
  ...
  return (
    <div style={{ margin: '2rem auto', width: '100%', maxWidth: '850px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <div className="pyramid-container-desktop" style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0' }}>
        ...
        {/* Level 6 */}
        <Link 
          href="/hierarchy-of-courts#level-6"
          onMouseEnter={() => setHoveredLevel(6)}
          onMouseLeave={() => setHoveredLevel(null)}
          style={{
            width: '260px',
            padding: '1.1rem 1.4rem',
            borderRadius: '8px',
            background: hoveredLevel === 6 ? 'linear-gradient(135deg, #B38F4F 0%, #8C5D23 100%)' : 'linear-gradient(135deg, #1A1816 0%, #2A2521 100%)',
            color: 'white',
            textAlign: 'center',
            cursor: 'pointer',
            boxShadow: hoveredLevel === 6 ? '0 10px 20px rgba(163, 112, 44, 0.35)' : 'var(--shadow-sm)',
            ...
            transform: hoveredLevel === 6 ? 'translateY(-3px) scale(1.02)' : 'none',
            zIndex: 6,
            position: 'relative'
          }}
        >
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.3rem', fontSize: '0.65rem', textTransform: 'uppercase', letterSpacing: '0.8px', color: hoveredLevel === 6 ? '#FAF8F5' : 'var(--accent-gold)', marginBottom: '0.15rem' }}>
            <Award size={12} /> Apex Revenue Court (Highest in State)
          </span>
          ...
          {hoveredLevel === 6 && (
            <div style={{
              ...
              <span style={{ fontSize: '0.72rem', opacity: 0.9, lineHeight: 1.35, fontWeight: 'normal', display: 'block' }}>
                {courtsDetail.find(c => c.id === 6).shortDesc}
              </span>
            </div>
          )}
        </Link>
        ...
        {/* Connector */}
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '1.75rem', margin: '0.4rem 0' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.2rem', color: 'var(--accent-gold)' }}>
            ...
            <svg width="10" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="20" x2="12" y2="4"></line><polyline points="5 11 12 4 19 11"></polyline></svg>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.2rem', color: 'var(--text-muted)' }}>
            <svg width="10" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="4" x2="12" y2="20"></line><polyline points="19 13 12 20 5 13"></polyline></svg>
        ...
        <Link 
          ...
          style={{
            ...
            padding: '1.1rem 1.4rem',
            borderRadius: '8px',
            background: hoveredLevel === 5 ? 'linear-gradient(135deg, #B38F4F 0%, #8C5D23 100%)' : 'linear-gradient(135deg, #201D1A 0%, #302B26 100%)',
            color: 'white',
            textAlign: 'center',
            cursor: 'pointer',
        ...
        {/* Level 4 (Revenue Appellate Authority RAA) */}
        <Link 
          ...
          style={{
            ...
            padding: '1.1rem 1.4rem',
            borderRadius: '8px',
            background: hoveredLevel === 4 ? 'linear-gradient(135deg, #B38F4F 0%, #8C5D23 100%)' : 'linear-gradient(135deg, #24201C 0%, #342E28 100%)',
            color: 'white',
            textAlign: 'center',
            cursor: 'pointer',
        ...
        >
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.3rem', fontSize: '0.65rem', textTransform: 'uppercase', letterSpacing: '0.8px', color: hoveredLevel === 4 ? '#FAF8F5' : 'var(--accent-gold)', marginBottom: '0.15rem' }}>
            <Scale size={12} /> Appellate Forum (Above Collector)
          </span>
          <span style={{ fontSize: '0.92rem', fontFamily: 'var(--font-serif)' }}>Revenue Appellate Authority (RAA)</span>
          ...
          {hoveredLevel === 4 && (
            <div style={{
              ...
              <strong style={{ color: 'var(--accent-gold)', display: 'block', marginBottom: '0.2rem', fontSize: '0.82rem', fontFamily: 'var(--font-serif)' }}>
                Revenue Appellate Authority (RAA)
              </strong>
              <span style={{ fontSize: '0.72rem', opacity: 0.9, lineHeight: 1.35, fontWeight: 'normal', display: 'block' }}>
        ...
        <Link 
          ...
          style={{
            ...
            padding: '1.1rem 1.4rem',
            borderRadius: '8px',
            background: hoveredLevel === 3 ? 'linear-gradient(135deg, #B38F4F 0%, #8C5D23 100%)' : 'linear-gradient(135deg, #282420 0%, #38322B 100%)',
            color: 'white',
            textAlign: 'center',
            cursor: 'pointer',
