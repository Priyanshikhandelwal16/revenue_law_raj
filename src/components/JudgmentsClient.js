...
import { Gavel, Calendar, Landmark, ArrowRight } from 'lucide-react';
import NewsSidebar from '@/components/NewsSidebar';

export default function JudgmentsClient({ initialJudgments = [], initialCourt = 'all', initialQ = '' }) {
