export const SITE_PAGES = [
  ...
  { title: 'Procedure of Revenue Law', href: '/working-of-revenue-law', aliases: ['working of law', 'revenue law procedure', 'procedure of revenue law'], keywords: ['workflow litigation process'], description: 'How revenue law proceedings work.' },
