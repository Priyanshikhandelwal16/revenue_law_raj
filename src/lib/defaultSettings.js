...
const courtHierarchyConfig = {
  ...
  courts: [
    ...
    { id: 4, level: "Appellate Authority", name: "Revenue Appellate Authority (RAA)", role: "Appellate Court above District Collector", responsibilities: "Intermediate appellate forum hearing revenue appeals from orders passed by Sub-Divisional Officers and District Collectors.", jurisdiction: "Divisional & Regional Jurisdiction.", casesHandled: "Appeals against SDO partition orders, Khatedari declarations, ejectment decrees, and land valuation disputes.", powers: "Appellate powers under Rajasthan Land Revenue Act, 1956 and Rajasthan Tenancy Act, 1955.", appealsGoTo: "Board of Revenue (BOR), Ajmer.", importantNotes: "Positioned directly above the District Collector to adjudicate revenue appeals before escalation to the Board of Revenue.", shortDescription: "Appellate court positioned above District Collector to hear appeals in land & tenancy matters." },
