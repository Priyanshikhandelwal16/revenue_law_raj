...
const homepageConfig = {
  ...
  categoriesSection: { eyebrow: "Subject Directory", title: "Judicial Matters", description: "Access structured directories covering key judicial matters in Rajasthan land and tenancy codes.", ctaLabel: "Browse Category Articles" },
  categories: [
