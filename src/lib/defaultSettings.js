...
const contactConfig = {
  schemaVersion: 1,
  hero: { eyebrow: "RRLKP Consultation", title: "Contact Our Editorial Board", highlight: "Submit Legal Query", description: "Have questions regarding a publication, need technical help, or want to contribute articles to the platform? Fill out the query form." },
