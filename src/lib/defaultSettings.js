...
const homepageConfig = {
  ...
  categories: [
    ...
    { title: "Tenancy Rights", description: "Khatedar and Gair-Khatedar tenant rights, protections, and restrictions under the Rajasthan Tenancy Act, 1955.", slug: "tenancy-rights", icon: "Scale" },
    { title: "Land Records & Jamabandi", description: "Procedure for updating, verifying, and correcting Jamabandi (Record of Rights) entries.", slug: "land-records", icon: "FileText" },
    { title: "Revenue Court Jurisdiction", description: "Powers, territorial limits, and pecuniary jurisdiction of revenue courts at each level.", slug: "court-jurisdiction", icon: "Landmark" },
    { title: "Government Land Allotment", description: "Rules for allotment of government wasteland for agricultural and other permissible purposes.", slug: "govt-land-allotment", icon: "MapPin" },
    { title: "SC/ST Land Protections", description: "Special statutory protections for Scheduled Caste and Scheduled Tribe landholders under revenue and tenancy law.", slug: "sc-st-protections", icon: "Shield" },
    { title: "Revenue Penalties & Offences", description: "Offences, penalties, and criminal provisions under the Rajasthan Land Revenue Act, 1956.", slug: "penalties-offences", icon: "AlertTriangle" },
  ],
  ...
  courts: [{ title: "Board of Revenue", role: "Highest Revenue Court (Highest Court in State)", location: "Ajmer" }, { title: "Revenue Appeals Court", role: "Appellate Commissioners", location: "Divisional HQ" }, { title: "Revenue Appellate Authority (RAA)", role: "Appellate Authority", location: "Divisional/Regional HQ" }, { title: "Collector Courts", role: "District Collectors / Add. Collectors", location: "District HQs" }, { title: "Sub-Divisional Courts", role: "SDOs / Assistant Collectors", location: "Sub-Division Level" }, { title: "Tehsildar Courts", role: "Tehsildars & Naib Tehsildars", location: "Tehsil HQs" }],
...
const legalConfig = {
  ...
  disclaimer: `<p><strong>Welcome to Rajasthan Revenue Law Platform (Revenue Law Raj).</strong></p><p>The statutory acts, tenancy rules, circular notifications, and judicial precedents published on this platform are compiled for research, general guidance, and educational reference under the <strong>Rajasthan Land Revenue Act, 1956</strong> and <strong>Rajasthan Tenancy Act, 1955</strong>.</p><h2>Important Notice</h2><p>This platform does not constitute formal advocate legal advice. Users and litigants are advised to verify statutory clauses and notification copies with official Rajasthan Government prints before pleading cases in revenue courts.</p><h2>No Advocate-Client Relationship</h2><p>No advocate-client relationship is created by accessing this website.</p><h2>Accuracy of Information</h2><p>All precedent summaries and gazette notifications are updated periodically from official sources. While we take every effort to keep our databases updated with accurate records from the Rajasthan Government Gazette and Board of Revenue Ajmer, we cannot guarantee that all records are completely free of typos or scanning errors.</p><h2>No Liability</h2><p>The owners, developers, and writers of the Rajasthan Revenue Law Platform shall not be held liable for any decisions, legal strategies, or filings executed based on the information provided on this website. Always verify statutory clauses with official government prints before pleading cases before a revenue court.</p><h2>Third-Party Links</h2><p>This portal may link to external government sites or resource platforms. We hold no responsibility for the uptime, validity, or content of external links.</p>`,
};
...
const courtHierarchyConfig = {
  ...
  courts: [
    { id: 6, level: "Highest Revenue Court", name: "Board of Revenue (BOR), Ajmer", role: "Appellate & Revisional Authority (Highest Court in the State)", responsibilities: "Apex judicial and administrative head of all revenue courts and land record systems in Rajasthan.", jurisdiction: "State-wide (Entire State of Rajasthan).", casesHandled: "Second appeals, revision petitions, and reference queries regarding tenancy disputes, land valuations, and boundary conflicts.", powers: "Supreme revisional, appellate, and administrative oversight. Its orders are binding on all subordinate revenue courts in the state.", appealsGoTo: "Hon'ble High Court of Rajasthan (Writ Jurisdiction).", importantNotes: "Established in 1949, the Board of Revenue is situated in Ajmer and is the highest court in the state for interpreting Rajasthan revenue codes.", shortDescription: "Apex judicial body and highest court in the state for all revenue matters in Rajasthan." },
    { id: 5, level: "Appellate Court", name: "Divisional Commissioner / Revenue Appeals Commissioner (RAC)", role: "First/Second Appeals", responsibilities: "Divisional appellate authority responsible for judicial review of orders passed by SDOs and District Collectors across the administrative division.", jurisdiction: "Division-wide Jurisdiction (encompassing multiple revenue districts).", casesHandled: "First & Second Appeals arising from major land administration decrees, agricultural partition orders, boundary disputes, and Collector appeals.", powers: "Divisional supervisory and appellate powers under Section 75 of the Rajasthan Land Revenue Act, 1956 and Section 223 of the Rajasthan Tenancy Act, 1955.", appealsGoTo: "Board of Revenue (BOR), Ajmer.", importantNotes: "Specialized divisional court established to expedite judicial resolution of revenue disputes before escalation to the apex Board of Revenue in Ajmer.", shortDescription: "Hears appeals against SDO and Collector orders on land disputes and tenancy decrees." },
    { id: 4, level: "Appellate Authority", name: "Revenue Appellate Authority (RAA)", role: "Appellate Court above District Collector", responsibilities: "Apex regional appellate forum designated under state land revenue & tenancy statutes to hear first appeals from original orders and decrees passed by Sub-Divisional Officers (SDO), Assistant Collectors, and District Collectors.", jurisdiction: "Divisional & Regional Jurisdiction across assigned revenue districts in Rajasthan.", casesHandled: "First appeals against SDO decrees in agricultural partition suits (Sec 53 RTA), Khatedari rights declarations (Sec 88 RTA), injunction disputes (Sec 188 RTA), ejectment decrees, and land valuation disputes.", powers: "Full statutory appellate powers under Section 75 & 76 of Rajasthan Land Revenue Act, 1956 and Section 223 & 224 of Rajasthan Tenancy Act, 1955, including power to grant interim stays, modify lower decrees, and remand suits.", appealsGoTo: "Board of Revenue (BOR), Ajmer (Second Appeal / Revisional Jurisdiction).", importantNotes: "Positioned directly above District Collectors as a dedicated judicial court for thorough appellate scrutiny of land and tenancy disputes before escalation to the Board of Revenue.", shortDescription: "Appellate court positioned above District Collector to hear revenue appeals in land & tenancy disputes." },
    { id: 3, level: "District Court", name: "District Collector / Additional Collectors", role: "Appellate & Administrative Head", responsibilities: "District revenue head, appellate authority for local revenue disputes, and supervisor of land record corrections.", jurisdiction: "District-wide.", casesHandled: "Appeals against Tehsildar's mutation and eviction orders; valuation of stamps; administrative land allotments; boundary corrections.", powers: "High administrative and appellate powers, including power to transfer cases, review lower orders, and record corrections (Sec. 136).", appealsGoTo: "Revenue Appellate Authority (RAA) / Divisional Commissioner / Board of Revenue, Ajmer.", importantNotes: "The Collector represents the state government at the district level, merging administrative power with revenue judicial authority.", shortDescription: "Adjudicates record corrections and hears appeals against Tehsildar mutation orders." },
    { id: 2, level: "Sub-Division Court", name: "Sub-Divisional Officer (SDO) / Assistant Collector", role: "Primary Trial Court for Suits", responsibilities: "Primary original trial court for major tenancy suits, declarations of rights, and land conversions.", jurisdiction: "Sub-Division scope (comprising multiple Tehsils).", casesHandled: "Tenancy declarations, agricultural partition suits, ejectment and injunction matters, and Section 90-A land-conversion proceedings.", powers: "Original judicial jurisdiction over major tenancy suits and delegated administrative authority for land conversion.", appealsGoTo: "Revenue Appellate Authority (RAA) / Revenue Appeals Commissioner (RAC) / District Collector.", importantNotes: "The SDO is a critical judicial authority where the majority of tenancy and land declaration disputes are instituted.", shortDescription: "The primary original trial court for major tenancy suits and land conversions (Sec. 90-A)." },
  ...
  appealProcess: { title: "Appeal Escalation Process", paragraphs: ["In revenue law, matters generally flow upwards from the local executive to the apex judicial body. If a petitioner is unsatisfied with a Tehsildar's mutation decision, they file an appeal with the District Collector. For suits regarding tenant ownership or partitions decided by SDO courts, the appeal lies with the Revenue Appellate Authority (RAA) or Revenue Appeals Commissioner (RAC).", "The Board of Revenue in Ajmer acts as the highest court in the state for all revenue disputes. Further appeals against the Board of Revenue are presented before the Hon'ble High Court of Rajasthan (Jaipur/Jodhpur benches) under Writ Jurisdiction."] },
};
